$(document).ready(function () {
    ...
    var submitFormAndLoadBoards = function () {
    ...
    var hideBaseAndLoadModal = function () {
        $('#modal-overlay').fadeToggle(100);
        $("#base-modal").modal("hide");
        var instance = $(this);
        $.ajax({
    ...
    $("#base-modal").on("submit", ".js-submit-form-boards", submitFormAndLoadBoards);
    $("#base-large-modal").on("submit", ".js-submit-large-form-boards", submitLargeFormAndLoadBoards);
    $("#base-modal").on("click", ".js-hide-base-load-modal", hideBaseAndLoadModal);
