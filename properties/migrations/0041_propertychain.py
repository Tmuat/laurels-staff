    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chain_notes', models.CharField(blank=True, max_length=1000, null=True)),
                ('order', models.IntegerField(null=True)),
                ('sales_progression', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales_progression_chain', to='properties.salesprogression')),
            ],
            options={
                'verbose_name': 'Sales Progression Chain',
                'verbose_name_plural': 'Sales Progressions Chain',
                'ordering': ['sales_progression__propertyprocess__property__postcode', 'sales_progression__propertyprocess__property__address_line_1', 'order'],
            },
        ),
    ]
